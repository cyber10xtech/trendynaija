...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Trendy Naija — Nigeria's AI Trend Intelligence Platform" },
      { name: "description", content: "Discover what Nigeria is talking about. AI-powered trend intelligence starting with Imo State." },
      { property: "og:title", content: "Trendy Naija — Nigeria's AI Trend Intelligence Platform" },
